...
export default function TempleImagesSection() {
  ...
  return (
    <section 
      className="bg-[var(--background)] relative border-y border-[var(--border)]" 
      ref={containerRef}
    >
      <div className="md:h-screen overflow-hidden">
        ...
        <div className="slide-panel slide-1 w-full md:w-screen md:h-full flex flex-col-reverse md:flex-row items-center p-6 md:p-12 lg:p-20 gap-8 md:gap-12">
          <div className="w-full md:w-1/3 flex flex-col justify-center space-y-6">
            <span className="section-kicker block text-[var(--accent-strong)]">Our Vision</span>
            ...
            <ul className="space-y-3 mt-4">
              <li className="flex items-center gap-3">
                ...
                <span className="font-medium text-[var(--ink-soft)]">Character Development</span>
              </li>
              <li className="flex items-center gap-3">
                <div className="w-2 h-2 rounded-full bg-[var(--accent)]" />
                <span className="font-medium text-[var(--ink-soft)]">Spiritual Wisdom</span>
              </li>
            </ul>
          </div>
          
          <div className="w-full md:w-2/3 h-[40vh] md:h-[80vh] relative rounded-2xl overflow-hidden shadow-2xl border border-[var(--border)] bg-white p-2">
            <Image 
        ...
        <div className="slide-panel slide-2 w-full md:w-screen md:h-full flex flex-col-reverse md:flex-row items-center p-6 md:p-12 lg:p-20 gap-8 md:gap-12 bg-[var(--surface-muted)]">
          <div className="slide-2-text w-full md:w-1/3 flex flex-col justify-center space-y-6">
            <span className="section-kicker block text-[var(--accent-strong)]">Curriculum</span>
            <h2 className="text-3xl lg:text-5xl font-bold text-[var(--foreground)] leading-tight">
            ...
            <div className="flex gap-4 mt-6">
              <div className="bg-white p-4 rounded-xl border border-[var(--border)] shadow-sm">
                <p className="text-2xl font-bold text-[var(--accent-strong)]">1 Year</p>
                <p className="text-xs text-[var(--ink-soft)] uppercase font-semibold tracking-wider mt-1">Duration</p>
              </div>
              <div className="bg-white p-4 rounded-xl border border-[var(--border)] shadow-sm">
                <p className="text-2xl font-bold text-[var(--accent-strong)]">4</p>
                <p className="text-xs text-[var(--ink-soft)] uppercase font-semibold tracking-wider mt-1">Modules</p>
              </div>
            </div>
          </div>
